	...
	<aside :class="`${is_expanded ? 'is-expanded' : ''}`">
		...
		<div class="menu">
			<router-link to="/Dashboard" class="button">
				<span class="material-icons">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house-gear-fill" viewBox="0 0 16 16">
			...
			<router-link to="/Book" class="button">
				<span class="material-icons">
			...
			<router-link to="/Publisher" class="button">
				<span class="material-icons">
				...
				<span class="text">Quản lý NSX</span>
			</router-link>
            ...
            <router-link to="/Employee" class="button">
				<span class="material-icons">
            ...
            <router-link to="/BorrowingCard" class="button">
				<span class="material-icons">
