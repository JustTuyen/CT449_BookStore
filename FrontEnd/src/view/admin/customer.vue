  ...
  <div class="d-flex bng">
    ...
    <div class="container-fluid">
      <div class="title">
        ...
        <hr class="my-3">
        <div class="actions">
          <button class="btn btn-success action-btn" @click="addnewModal">Thêm người dùng</button>
        ...
        <table id="users">
          ...
          <tbody>
            <tr v-for="(user, index) in users" :key="user._id">
              ...
              <td>
                <button class="btn btn-warning btns" type="button" @click="openUpdateModal(user)">Edit</button>
                <button class="btn btn-danger btns" type="button" @click="deleteItem(user._id)">Xóa</button>
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <div class="mb-3 row">
            <div class="col">
              ...
              <select class="form-select" aria-label="select example" 
                required v-model="UpdateCardForm.GioiTinh">
                  <option value="Nam">Nam</option>
